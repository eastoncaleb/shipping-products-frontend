  ...
  return (
    <div className="App flex flex-wrap justify-center">
      ...
      <div className="flex flex-wrap text-center p-4 bg-white">
        <h3 className="capitalize text-gray-800 w-full mx-auto py-2 px-4 text-2xl lg:text-3xl font-bold">Not sure what size <FontAwesomeIcon icon={faBox} className="mx-1 text-green-600" /> you need?</h3>
      ...
      <div className="flex w-full md:w-1/2">
        {productName && <div className="text-gray-700 w-full text-2xl my-10 font-bold text-center tracking-wide">
      ...
      <div id="footer" className="bg-gray-200 w-full absolute bottom-0 p-8 text-sm text-gray-500 text-right">
